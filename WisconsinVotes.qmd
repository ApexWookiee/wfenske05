---
title: "Wisconsin Votes from 2016 Presidential Election"
sidebar: false
format: html
editor: visual
editor_options: 
...
Now we will take data from [here](http://cdmaps.polisci.ucla.edu/shp/districts113.zip) and overlay it onto the template created above. The result is the following map: 
